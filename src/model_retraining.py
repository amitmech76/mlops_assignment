...
class ModelRetrainer:
    ...
    def _retrain_housing_model(
        ...
        try:
            ...
            with mlflow.start_run(run_name=f"Retraining-{job_id}"):
                ...
                mlflow.log_param(
                    "trigger_type", self.retraining_jobs[job_id]["trigger_type"]
                )
    ...
    def check_performance_drop(
        self, model_name: str, current_performance: float
    ) -> bool:
    ...
    def check_data_drift(
        self, model_name: str, reference_data: pd.DataFrame, current_data: pd.DataFrame
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            for feature in features:
                if feature in current_data.columns:
                    ...
                    stat, p_value = ks_2samp(
                        reference_data[feature].dropna(), current_data[feature].dropna()
                    )
            ...
            metrics_collector.record_data_drift(
                model_name, avg_drift_score, drift_detected
            )
    ...
    def _get_estimated_duration(self, model_name: str) -> int:
        ...
        estimates = {"housing": 5, "iris": 3}  # 5 minutes  # 3 minutes
