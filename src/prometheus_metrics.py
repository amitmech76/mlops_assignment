...
class MetricsCollector:
    ...
    def record_prediction(self, model_name: str, status: str, duration: float, confidence: Optional[float] = None):
    ...
    def record_model_performance(self, model_name: str, metric_name: str, value: float):
        ...
        MODEL_PERFORMANCE.labels(model_name=model_name, metric_name=metric_name).set(value)
    ...
    def record_business_metric(self, metric_name: str, model_name: str, value: float = 1):
        """Record business-specific metrics"""
        BUSINESS_METRICS.labels(metric_name=metric_name, model_name=model_name).inc(value)
